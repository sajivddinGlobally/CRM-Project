...
//
//     final getClienDetailsModel = getClienDetailsModelFromJson(jsonString);

import 'dart:convert';

GetClienDetailsModel getClienDetailsModelFromJson(String str) => GetClienDetailsModel.fromJson(json.decode(str));

String getClienDetailsModelToJson(GetClienDetailsModel data) => json.encode(data.toJson());

class GetClienDetailsModel {
    bool? status;
    String? message;
    Data? data;

    GetClienDetailsModel({
        this.status,
        this.message,
        this.data,
    });

    factory GetClienDetailsModel.fromJson(Map<String, dynamic> json) => GetClienDetailsModel(
        status: json["status"],
