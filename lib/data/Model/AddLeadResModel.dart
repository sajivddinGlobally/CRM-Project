...
AddLeadResModel addLeadResModelFromJson(String str) => AddLeadResModel.fromJson(json.decode(str));

String addLeadResModelToJson(AddLeadResModel data) => json.encode(data.toJson());
...
class AddLeadResModel {
    ...
    factory AddLeadResModel.fromJson(Map<String, dynamic> json) => AddLeadResModel(
        status: json["status"],
